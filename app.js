...
const accomodations = require('./routes/accomodation');
const bedType = require('./routes/bedType');
const accomodationsType = require('./routes/accomodationType');
...
app.use('/accomodationsType', accomodationsType);
